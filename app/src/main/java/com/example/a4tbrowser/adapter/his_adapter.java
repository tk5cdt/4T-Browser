...
public class his_adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public his_adapter(Context context, List<Object> items) {
    ...
    private OnWebsiteClickListener websiteClickListener;
...
//                @Override
//                public void onClick(View v) {
//                    Websites websiteToDelete = (Websites) items.get(getAdapterPosition());
//                    deleteClickListener.onDeleteClick(websiteToDelete);
//                }
//            });
        }
